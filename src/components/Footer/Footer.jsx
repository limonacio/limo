...
const SOCIALS = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/limoestayferraris/',
    icon: (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/limonacio',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@limonacio',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/limonacio/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
